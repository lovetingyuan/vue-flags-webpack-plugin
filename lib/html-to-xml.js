/**
 * code from: https://github.com/vuejs/vue/blob/master/src/compiler/parser/html-parser.js
 */
...
const _isNonPhrasingTag = makeMap(
...
function isNonPhrasingTag() {
  return _isNonPhrasingTag.apply(this, arguments)
}
...
module.exports = function toXml (html) {
  const results = []
