...
module.exports = function postcssFlagsPlugin () {
  return function supportsFlagsPlugin (css) {
    css.walkAtRules(function (rule) {
      ...
      if (notHandle) {
        if (hasFlag) {
          console.log(`${chalk.red('postcss-flags-plugin warning:')} ${POSTCSS_SUPPORT_PROPERTY} can not be used with other properties:`)
      ...
      try {
        const result = (new Function(`with(this){return ${expression}}`)).call(pluginOptions.flags) // eslint-disable-line
